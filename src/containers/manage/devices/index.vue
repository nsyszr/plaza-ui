<template>
  <v-layout wrap>
    <v-flex xs10 offset-xs1>
      <device-list :devices="devices" :headers="headers" :sortBy="sortBy" :sortDesc="sortDesc" />
      <add-device-dialog v-model="createDeviceDialog" v-on:create="createDevice" />
    </v-flex>
  </v-layout>
</template>
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      createDevice: "$_manage_devices/createDevice",
