...
export default {
  ...
  data() {
    return {
      ...
      deviceSerialNumberRules: [
        v => !!v || 'Serial number is required'
      ],
      deviceFamilies: ['MRX/MRO Series', 'SCR/ECR Series'],
      projects: ['INSYS #1']
    }
  },
  watch: {
    value() {
      this.device = Object.assign({}, { name: null, serialNumber: null, status: 'REGISTERED' })
